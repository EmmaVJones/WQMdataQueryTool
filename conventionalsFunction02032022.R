...
conventionalsSummary <- function(conventionals, stationFieldDataUserFilter, stationAnalyteDataUserFilter, stationInfo, stationGIS_View, dropCodes, assessmentUse,
  ...
  if(nrow(stationData) > 0){                             
    ...
    if(nrow(stationAnalyteDataUserFilter0_0) > 0){
      ...
      stationAnalyteDataUserFilter1 <- parameterTemplate    }
    ...
    if(nrow(stationAnalyteDataUserFilter0_0) > 0){
      ...
      stationAnalyteDataUserFilter2 <- remarkTemplate    }
    stationAnalyteDataUserFilter2 <- stationAnalyteDataUserFilter2 %>% 
