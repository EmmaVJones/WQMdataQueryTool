  ...
  tagList(
    wellPanel(
      ...
      fluidRow(column(4,uiOutput(ns('oneStationSelectionUI'))),
               ...
               column(2,helpText('WQS adjustment applies to this module instance and does not save WQS adjustments or carry over to other modules.'))),#pooled AU assessments.')),
               # column(1),
