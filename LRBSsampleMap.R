...
CreateWebMap(maps = c("Topo","Imagery","Hydrography"), collapsed = TRUE,
  ...
  addCircleMarkers(data = LRBSstationsSummary,
                   ...
                   fillOpacity = 0.5,opacity=0.8,weight = 2,stroke=T, group="Station With LRBS Data",
  ...
  addLayersControl(baseGroups=c("Topo","Imagery","Hydrography"),
                   overlayGroups = c("Station With LRBS Data","Subbasins", "Level III Ecoregions", 'Assessment Regions'),
